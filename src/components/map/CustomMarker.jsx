              ...
              <Tooltip permanent direction='top' opacity={1} interactive>
                <div className='p-2 w-52'>
                  ...
                  <div className='pb-2 basis-3/4 '>
                    ...
                    <div className='py-2'>
                      <img src={marker.img ? marker.img : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiKeMxWylWa9X7J859YdKx5r6XE1q45o7-jmnZ9p5xhNMRwrk6qICM0FZO8u7JOnR-F3M&usqp=CAU'} alt='' className='lg:flex' />
                    </div>
