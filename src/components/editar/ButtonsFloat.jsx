...
export const ButtonsFloat = () => {
  ...
  return (
    <>
      ...
      <div data-dial-init className='fixed  z-[1050] ps-1 top-6'>
        ...
        <div id='speed-dial-menu-square' className={`flex flex-col items-center my-2 space-y-2 ${!open ? 'hidden' : 'flex'}`}>
          <ButtonLocation action='locations' />
          <ButtonLink action='link' />
          <ButtonSetting action='config' />
          <ButtonLayer action='layer' />
          <ButtonCenterPosition action='centerPosition' />
        </div>
      </div>
